...
rmv_task04__msg__ObjectArray__init(rmv_task04__msg__ObjectArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    rmv_task04__msg__ObjectArray__fini(msg);
    return false;
  }
  // objects
  if (!rmv_task04__msg__Object__Sequence__init(&msg->objects, 0)) {
    rmv_task04__msg__ObjectArray__fini(msg);
    return false;
  }
  return true;
...
rmv_task04__msg__ObjectArray__fini(rmv_task04__msg__ObjectArray * msg)
{
  ...
  // objects
  rmv_task04__msg__Object__Sequence__fini(&msg->objects);
}
...
rmv_task04__msg__ObjectArray__are_equal(const rmv_task04__msg__ObjectArray * lhs, const rmv_task04__msg__ObjectArray * rhs)
{
  ...
  // objects
  if (!rmv_task04__msg__Object__Sequence__are_equal(
  ...
  rmv_task04__msg__ObjectArray * output)
{
  ...
  // objects
  if (!rmv_task04__msg__Object__Sequence__copy(
...
rmv_task04__msg__ObjectArray__create()
{
  ...
  rmv_task04__msg__ObjectArray * msg = (rmv_task04__msg__ObjectArray *)allocator.allocate(sizeof(rmv_task04__msg__ObjectArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rmv_task04__msg__ObjectArray));
  bool success = rmv_task04__msg__ObjectArray__init(msg);
  if (!success) {
...
rmv_task04__msg__ObjectArray__Sequence__init(rmv_task04__msg__ObjectArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmv_task04__msg__ObjectArray * data = NULL;

  if (size) {
    data = (rmv_task04__msg__ObjectArray *)allocator.zero_allocate(size, sizeof(rmv_task04__msg__ObjectArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rmv_task04__msg__ObjectArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rmv_task04__msg__ObjectArray__fini(&data[i - 1]);
      }
...
rmv_task04__msg__ObjectArray__Sequence__fini(rmv_task04__msg__ObjectArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rmv_task04__msg__ObjectArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rmv_task04__msg__ObjectArray__Sequence * array = (rmv_task04__msg__ObjectArray__Sequence *)allocator.allocate(sizeof(rmv_task04__msg__ObjectArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rmv_task04__msg__ObjectArray__Sequence__init(array, size);
  if (!success) {
...
rmv_task04__msg__ObjectArray__Sequence__destroy(rmv_task04__msg__ObjectArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rmv_task04__msg__ObjectArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rmv_task04__msg__ObjectArray__Sequence__are_equal(const rmv_task04__msg__ObjectArray__Sequence * lhs, const rmv_task04__msg__ObjectArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rmv_task04__msg__ObjectArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rmv_task04__msg__ObjectArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rmv_task04__msg__ObjectArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rmv_task04__msg__ObjectArray * data =
      (rmv_task04__msg__ObjectArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rmv_task04__msg__ObjectArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rmv_task04__msg__ObjectArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rmv_task04__msg__ObjectArray__copy(
