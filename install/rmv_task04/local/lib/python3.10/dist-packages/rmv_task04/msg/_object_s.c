...
bool rmv_task04__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rmv_task04.msg._object.Object", full_classname_dest, 29) == 0);
  }
  rmv_task04__msg__Object * ros_message = _ros_message;
  {  // header
...
PyObject * rmv_task04__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rmv_task04.msg._object");
